...
class BVHAccel : public Aggregate {
 public:
  ...
  /**
    * recursive build BVH
  **/
  void BVHBuild(BVHNode * node, std::vector<Primitive *> &_primitives, size_t max_leaf_size);


  /**
    *  update best cost, best primitives
    *  best_left_primitives, best_right_primitives, node
  **/
  double bestCost(std::string flag, 
  ...
  /**
    * return best cost 
  **/
  double computeCost(BBox currbb, BBox leftbb, BBox rightbb, int leftCount, int rightCount);
  ...
  /**
    * helper function, update isect when ray intersects bbox of node
  **/
  void find_closest_hit(const Ray &ray, BVHNode * node, Intersection * isect) const;
